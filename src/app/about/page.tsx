...
export const metadata = {
  title: 'О мастере Еве - Профессиональный маникюр в Минске',
  description: 'Узнайте больше о мастере маникюра Еве в Минске. Опыт более 5 лет, профессиональное образование и индивидуальный подход к каждому клиенту.',
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-gray-600">
                ...
                <p>
                  Моя страсть к маникюру началась много лет назад, когда я осознала, насколько важно для женщины чувствовать себя уверенной и красивой. Я прошла профессиональное обучение и регулярно повышаю квалификацию, изучая новейшие техники и тенденции.
                </p>
                <p>
