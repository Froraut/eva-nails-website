              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+375333014486" className="text-primary hover:text-primary-dark text-lg">
                      +375 33 301-44-86
                    </a>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Минск, Беларусь<br />
                      Станция метро: уточняется при записи
                    </p>
                    <p className="text-gray-600 text-sm mt-1">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="flex space-x-4 mt-2">
                      <a href="https://www.instagram.com/_nogtepilka.minsk" className="text-gray-600 hover:text-primary transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Работаю на выезде по Минску или в партнёрских салонах
            </p>
          </div>
